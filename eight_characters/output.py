...
def normalize_output_numeric_precision(payload: dict[str, Any]) -> dict[str, Any]:
    intermediate = payload['intermediate']
    intermediate['solar_longitude_deg'] = _rounded(
        intermediate['solar_longitude_deg'], 6
    )
    intermediate['equation_of_time_minutes'] = _rounded(
